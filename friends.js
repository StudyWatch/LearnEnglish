...
function displayTips() {
    const tips = [
        ...
        "חזרה על המילים: לאחר סיום הפרק, חזור על רשימת המילים. נסה לכתוב משפט אחד לפחות עם כל מילה לשילוב הטכניקה שלמדת.",
        "שימוש בתרגומים: אם יש מילה שאתה לא מבין, עזור לעצמך במילון או בתרגום כדי להבין את משמעותה המדויקת.",
        "צפייה מחודשת: צפה שוב בפרקים שכבר ראית, כעת נסה להבין את התוכן והשפה ללא תרגום. זה מאפשר תרגול יעיל יותר של ההבנה.",
        "תרגול עם חברים: שוחח על הסדרות והמילים שלמדת עם חברים שלומדים גם הם אנגלית. זה ישפר את הדיבור והבנת השפה.",
        "הקלט והאזן: הקלט את עצמך מדבר באנגלית ואז האזן להקלטה. זה יסייע לך לזהות איזו תיקון נדרש בהגייה ובשימוש בשפה.",
