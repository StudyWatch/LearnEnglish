...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const didYouKnowFacts = [
    ...
    function displayTips() {
      const tips = [
    { tip: "רשימת מילים", description: "לפני כל פרק, עבור על רשימת המילים שאתה עתיד ללמוד. זה יעזור לך להכיר ולזהות את המילים במהלך הצפייה." },
    { tip: "צפייה פעילה", description: "כשאתה צופה בסדרה, שים לב במיוחד למילים וביטויים שלמדת. נסה להיות ממוקד ולהבין איך הם משולבים בדיאלוג." },
    { tip: "חזרה על המילים", description: "לאחר סיום הפרק, חזור על רשימת המילים. נסה לכתוב משפט אחד לפחות עם כל מילה לשילוב הטכניקה שלמדת." },
    { tip: "שימוש בתרגומים", description: "אם יש מילה שאתה לא מבין, עזור לעצמך במילון או בתרגום כדי להבין את משמעותה המדויקת." },
    { tip: "צפייה מחודשת", description: "צפה שוב בפרקים שכבר ראית, כעת נסה להבין את התוכן והשפה ללא תרגום. זה מאפשר תרגול יעיל יותר של ההבנה." },
    { tip: "תרגול עם חברים", description: "שוחח על הסדרות והמילים שלמדת עם חברים שלומדים גם הם אנגלית. זה ישפר את הדיבור והבנת השפה." },
    { tip: "הקלט והאזן", description: "הקלט את עצמך מדבר באנגלית ואז האזן להקלטה. זה יסייע לך לזהות איזו תיקון נדרש בהגייה ובשימוש בשפה." },
    { tip: "שימוש ביומן", description: "רשום ביומן את התובנות והשאלות שלך לגבי הלמידה. זה יעזור לך לעקוב אחרי ההתקדמות ולהתמיד בלמידה." },
    { tip: "חשיבה באנגלית", description: "נסה לחשוב על התוכן שראית באנגלית. זה יכול להיות מאתגר אך יעזור לך להפנים את השפה באופן יותר טבעי." }
];
